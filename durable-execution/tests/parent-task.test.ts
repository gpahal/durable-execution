...
describe('parentTask', () => {
  ...
  it('should fail with one child failing', async () => {
    ...
    expect(finishedExecution.childrenTasksErrors[0]!.error?.getErrorType()).toBe('generic')
  ...
  it('should fail with multiple children failing', async () => {
    ...
    expect(finishedExecution.childrenTasksErrors[1]!.error?.getErrorType()).toBe('generic')
  ...
  it('should fail with finalizeTask failing', async () => {
    ...
    expect(finishedExecution.finalizeTaskError?.getErrorType()).toBe('generic')
