...
describe('getTaskExecutionStorageUpdate', () => {
  it('should handle empty update', () => {
    ...
    expect(update.unset?.executorId).toBeUndefined()
    expect(update.isFinished).toBeUndefined()
    expect(update.unset?.runOutput).toBeUndefined()
    expect(update.unset?.error).toBeUndefined()
    expect(update.startedAt).toBeUndefined()
    expect(update.unset?.startedAt).toBeUndefined()
    expect(update.unset?.expiresAt).toBeUndefined()
    ...
    expect(update.unset?.onChildrenFinishedProcessingExpiresAt).toBeUndefined()
    expect(update.onChildrenFinishedProcessingFinishedAt).toBeUndefined()
    expect(update.unset?.closeExpiresAt).toBeUndefined()
  ...
  it('should handle ready update', () => {
    ...
    expect(update.unset?.executorId).toBe(true)
    expect(update.isFinished).toBeUndefined()
    expect(update.unset?.runOutput).toBe(true)
    expect(update.unset?.error).toBeUndefined()
    expect(update.startedAt).toBeUndefined()
    expect(update.unset?.startedAt).toBe(true)
    expect(update.unset?.expiresAt).toBe(true)
    expect(update.waitingForChildrenStartedAt).toBeUndefined()
    expect(update.waitingForFinalizeStartedAt).toBeUndefined()
    expect(update.finishedAt).toBeUndefined()
    expect(update.unset?.onChildrenFinishedProcessingExpiresAt).toBeUndefined()
  ...
  it('should handle waiting_for_children update', () => {
    ...
    expect(update.isFinished).toBeUndefined()
    expect(update.unset?.runOutput).toBeUndefined()
    expect(update.unset?.error).toBe(true)
    expect(update.startedAt).toBeUndefined()
    expect(update.unset?.startedAt).toBeUndefined()
    expect(update.unset?.expiresAt).toBe(true)
  ...
  it('should handle on_children_finished_processing_status idle update', () => {
    ...
    expect(update.waitingForFinalizeStartedAt).toBeUndefined()
    expect(update.finishedAt).toBeUndefined()
    expect(update.unset?.onChildrenFinishedProcessingExpiresAt).toBe(true)
    expect(update.onChildrenFinishedProcessingFinishedAt).toBeUndefined()
    expect(update.unset?.closeExpiresAt).toBeUndefined()
    expect(update.closedAt).toBeUndefined()
    expect(update.updatedAt).toBe(now)
  ...
  it('should handle close_status idle update', () => {
    ...
    expect(update.unset?.onChildrenFinishedProcessingExpiresAt).toBeUndefined()
    expect(update.onChildrenFinishedProcessingFinishedAt).toBeUndefined()
    expect(update.unset?.closeExpiresAt).toBe(true)
    expect(update.closedAt).toBeUndefined()
    expect(update.updatedAt).toBe(now)
  })
